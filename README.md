...
1. Write the JSON schema describing your resource, `aws-sam-apiauthvalidator.json`
2. Implement your resource handlers in `aws_sam_apiauthvalidator/handlers.py`
